...
create_my_armory_item()
create_my_amrmory_weapon()
create_my_character()
create_my_character_inv()
create_my_cleric()
create_my_mage()

load_my_armory_item()
load_my_armory_weapon()
load_my_character()
load_my_character_inv()
load_my_cleric()
load_my_mage()

# print(query_my_armory_item())
# print('************************************************************')
# print(query_my_armory_weapon())
# print('************************************************************')
print(query_my_character(2))
print('************************************************************')
# print(query_my_character_inv())
# print('************************************************************')
# print(query_my_cleric())
# print('************************************************************')
# print(query_my_mage())

# print(query_my_char_weapon_inv())

print(my_gain_hp(2, 5))
print('*********')
print(my_gain_strength(2, 6))
print('*********')
print(my_gain_intelligence(2, 12))
# my_conn.commit()
...
#my_urs.execute('DELETE FROM table_one WHERE Name="Brandon3"')
# my_curs.execute('UPDATE table_one SET Weight = Weight * 3 WHERE Age >= 32')
# my_curs.execute('''SELECT * FROM table_one''')
# print(my_curs.fetchall())
# print(len('''    q = ('UPDATE `character` SET strength = strength + {} '.format(str_gain) +'''))